...
class Triangle {
    ...
    render() {
        ...
        shapeCode = `<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg">  //create code for generating shape with variables from input<polygon points="${coordinates}" fill="${shapeColour}" />
